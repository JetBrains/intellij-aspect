...
_IntelliJInfo = provider(
    ...
    fields = {
        ...
        "internal_results": "dict[Provider, struct] - Cross-target internal results of modules executed on this target (for performance reasons not all results can be retained).",
    },
)
