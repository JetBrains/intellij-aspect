...
_IntelliJInfo = provider(
    ...
    fields = {
        ...
        "dependencies": "dict[int, depset[IntellijInfo]|None] - Direct dependencies grouped by dependency type (see intellij_deps constants).",
        "internal_results": "dict[Provider, struct]|None - Cross-target internal results of modules executed on this target (for performance reasons not all results can be retained).",
    },
)
